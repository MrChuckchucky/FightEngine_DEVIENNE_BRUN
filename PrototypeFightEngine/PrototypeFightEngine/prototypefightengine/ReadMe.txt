========================================================================
    APPLICATION CONSOLE : Vue d'ensemble du projet PrototypeFightEngine
========================================================================

AppWizard a créé cette application PrototypeFightEngine pour vous.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application PrototypeFightEngine.


PrototypeFightEngine.vcxproj
...
PrototypeFightEngine.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) PrototypeFightEngine.pch et un fichier de type précompilé nommé StdAfx.obj.
